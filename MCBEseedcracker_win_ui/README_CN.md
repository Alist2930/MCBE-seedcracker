...
详见 [MCBEseedcracker_win_ui/README_CN.md](README_CN.md)。
...
5. （可选）在「设置」中手动设置进程数（默认16进程，已是最优值）
6. 点击「开始破解」
7. 等待破解完成，查看完整种子

**进程数设置说明：**

- **高32位破解仅支持CPU模式**：进程数设置有效
- **默认16进程**：这是经过测试的最优值（避免内存带宽饱和）
- **推荐**：保持默认16进程即可，更多进程不会提升性能
