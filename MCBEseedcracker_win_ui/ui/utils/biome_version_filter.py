...
VERSION_BIOMES = {
    ...
    '1.21.60-26.23': [
        186  # Pale Garden (Expanded range in Bedrock 1.21.60-26.23+, corresponds to Java 1.21.5+)
    ],
    '26.30+': [
        187  # Sulfur Caves (Added in Bedrock 26.30+, corresponds to Java 26.2 Chaos Cubed Drop)
    ],
}
...
def normalize_version(version_key):
    ...
    VERSION_MAPPING = {
        ...
        # 1.21.60-26.23: Supports Pale Garden with expanded range (corresponds to cubiomes MC_1_21_5)
