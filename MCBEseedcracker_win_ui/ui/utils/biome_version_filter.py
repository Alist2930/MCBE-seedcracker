...
VERSION_BIOMES = {
    ...
    '1.21.60-1.21.132': [
        186  # Pale Garden (Expanded range in Bedrock 1.21.60-1.21.132+, corresponds to Java 1.21.5+)
    ],
}
...
def normalize_version(version_key):
    ...
    - 1.21.60-1.21.132 = Java 1.21.5-1.21.11 (MC_1_21_5) - Pale Garden expanded range
    ...
    Examples:
        ...
        "1.21-1.21.40" → "1.21-1.21.40" (does not support Pale Garden)
        "1.20.60-81" → "1.20.60-81"
        "1.20.0-51" → "1.20.0-51"
    """
    # Version mapping (based on biome generation characteristics)
    VERSION_MAPPING = {
        # 1.21.60-1.21.132: Supports Pale Garden with expanded range (corresponds to cubiomes MC_1_21_5)
        "1.21.60-1.21.132": "1.21.60-1.21.132",
    ...
    return VERSION_MAPPING.get(version_key, "1.21.60-1.21.132")
