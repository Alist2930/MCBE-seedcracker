...
| 基岩版版本        | MC_VERSION_STR 值 | 支持的群系                  |
| ----------------- | ----------------- | --------------------------- |
| **26.30+**        | `"26.30+"`        | ✅ 硫磺洞穴（新洞穴群系）   |
| **1.21.60-26.23** | `"1.21.60-26.23"` | ✅ 苍白之园（扩大范围）     |
| **1.21.50**       | `"1.21.50"`       | ✅ 苍白之园（较小范围）     |
| **1.21-1.21.40**  | `"1.21-1.21.40"`  | ❌ 不支持苍白之园           |
| **1.20.60-81**    | `"1.20.60-81"`    | ✅ 樱花树林                 |
| **1.20.0-51**     | `"1.20.0-51"`     | ✅ 樱花树林                 |
| **1.19**          | `"1.19"`          | ✅ 深暗之域、红树林沼泽     |
| **1.18**          | `"1.18"`          | ✅ 溶洞、繁茂洞穴、山地群系 |
